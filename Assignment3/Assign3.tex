...
First, verifying if $u^TV^{-1}u-f = 0$. To do this, finding $V^{-1}$ by augmenting with identity matrix and row reducing as follows :
\begin{align}
...
\end{align}
Thus the diagonal matrix \vec{D} is given as
\begin{align}
    \vec{D} = \myvec{\dfrac{5+\sqrt{34}}{2} & 0\\ 0 & \dfrac{5-\sqrt{34}}{2}}
\end{align}
So, the equation of the pair of straight lines is given by :
\begin{align}
    \vec{y}^T\myvec{\dfrac{5+\sqrt{34}}{2} & 0\\ 0 & \dfrac{5-\sqrt{34}}{2}}y =0
\end{align}
\end{document}